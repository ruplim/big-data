...
public class ViewCount extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception{
        ...
        Path inputFilePath = new Path("/home/training/workspace/MapReduce/input/sample1/data.txt");
        Path outputFilePath = new Path("/home/training/workspace/MapReduce/output/sample1");
